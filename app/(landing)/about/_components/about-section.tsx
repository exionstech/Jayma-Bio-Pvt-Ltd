...
const AboutUsSection = () => {
  return (
    <>
      ...
      >
        <div className="pt-4 md:py-8 px-5 md:px-10 lg:px-12 flex flex-col items-center gap-5 md:gap-12 max-w-screen-2xl mx-auto min-h-screen">
          <div className="w-full flex flex-col items-center justify-center py-3 gap-8 md:gap-12 pb-4 md:pb-6">
            ...
            <p className="text-sm md:text-lg font-medium text-green text-center w-full md:w-[80%] leading-[1.5rem] md:leading-[2.1rem]">
              ...
              sustainable products for a healthier planet. Our journey began
              with kombucha, symbolizing eco-conscious wellness, and led to
              innovations like bacterial cellulose for sustainable textiles and
              packaging. Collaborating with NIT Rourkela students, we bridge
              research with real-world applications, fueling creativity in
              biotechnology. Our latest product, the Sap Symphony, transforms
              plant signals into music, deepening our connection with nature. At
              JAYMA, sustainability drives every choice. Join us in pioneering a
              future where responsible living is accessible to all.
            </p>
          </div>
          <div className="w-full flex items-center justify-center flex-col gap-5 md:gap-10">
            ...
            <div className="hidden w-full md:flex flex-col md:gap-8 items-center justify-center mt-4 md:mt-8s md:pb-10">
