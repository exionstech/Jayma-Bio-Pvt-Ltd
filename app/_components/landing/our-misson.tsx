...
const MissionSection = () => {
  ...
  return (
    <section className="w-full bg-[#D9E6BA] md:rounded-t-[60px] rounded-t-[30px]">
      <div className="w-full flex flex-col items-center max-w-screen-2xl mx-auto h-full mt-20">
        <div className="w-full flex justify-end items-end">
          <div className="flex justify-center w-[25%] md:w-[20%] items-center self-end bg-white md:py-10 py-4 rounded-bl-3xl gap-2 font-semibold text-green text-xs md:text-[18px] cursor-pointer">
            Know More
