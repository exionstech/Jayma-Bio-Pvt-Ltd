  ...
  return (
    <section className="w-full px-5 md:px-14 min-h-screen flex flex-col max-w-screen-2xl mx-auto h-full pt-10 gap-[5rem]">
      <div className="flex flex-col md:flex-row">
        ...
        <span className="bg-lightGreen text-green py-0.5 px-3 leading-[2.8rem] md:leading-[4.3rem] 2xl:leading-[5.3rem] md:px-4 rounded-full text-3xl 2xl:text-6xl md:text-5xl font-bold md:font-semibold items-center justify-center w-24 md:w-auto">Says</span>
      </div>
